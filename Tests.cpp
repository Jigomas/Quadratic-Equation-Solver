...
void All_Tests()
{
    const int AMOUNT_OF_TESTS = 2;
                                       //  a, b, c, x1, x2, Amount_Of_Roots_Of_Quadratic_Equation
...
void Test_With_Structures(Types_Of_Coefficients *data, double *x1_Test, double *x2_Test)
{
    ...
    Solve_Quadratic_Equation((*data).a, (*data).b, (*data).c, x1_Test, x2_Test);
}
                        ...
                        double x1_Expected, double x2_Expected, int Amount_Of_Roots_Expected)
{
    ...
    int Amount_Of_Roots_Of_Quadratic_Equation = Solve_Quadratic_Equation(a, b, c, &x1, &x2);

    if ( (Amount_Of_Roots_Of_Quadratic_Equation != Amount_Of_Roots_Expected)
        ...
        || (x2 < x2_Expected - SMALL_DIFF) )
    {
        printf("Test %d Failed: a = %lg, b = %lg, c = %lg, x1 = %lg, x2 = %lg, "
                "Amount_Of_Roots_Of_Quadratic_Equation = %d\n",Test_Number, a, b, c, x1, x2,
                                                         Amount_Of_Roots_Of_Quadratic_Equation);

        printf("Expected: x1 = %lg, x2 = %lg, Amount_Of_Roots_Of_Quadratic_Equation = %d\n",
