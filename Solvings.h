#ifndef ONLINE_SOLVINGS
#define ONLINE_SOLVINGS
...
int Solving_Quadratic_Or_Linear_Equation(int *Current_Code_Of_Program)
{
    ...
    while (*Current_Code_Of_Program == PROGRAM_STILL_IN_PROGRESS)
    {
        ...
        Inputs_Of_Numbers_With_Three_Rewritings(&(Equation.a), &(Equation.b), &(Equation.c));
        int Amount_Of_Roots_Of_Quadric_Equation = QUADRATIC_EQUATION_ERROR;
        if ( 0 != fabs(Equation.a) )
            Amount_Of_Roots_Of_Quadric_Equation =
                            Solve_Quadric_Equation(Equation.a, Equation.b, Equation.c,
                                                 &(Equation.x1), &(Equation.x2));
        else
            Amount_Of_Roots_Of_Quadric_Equation = Solve_Linear_Equation(Equation.b,
                           ...
                           double c, double *x1, double *x2)
{
    ...
    else if (Is_Close_To_Zero(Discr) == 1)
    {
